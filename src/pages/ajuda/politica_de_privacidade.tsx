...
export default function politia_de_privacidade() {
  ...
  return (
    <css.Container>
      <Head>
        ...
        <meta name="description" content="A sua privacidade é importante para nós. É política do Gudbrand Loja 
      de Artigos do Vestuário respeitar a sua privacidade em relação a qualquer 
      informação sua que possamos coletar no site"/>
      </Head>
      <h2>Política Privacidade</h2>

      <p>
        A sua privacidade é importante para nós. É política do Gudbrand Loja
        de Artigos do Vestuário respeitar a sua privacidade em relação a qualquer
      informação sua que possamos coletar no site <Link href='https://gudbrand.com.br'><a> Gudbrand Loja de Artigos do Vestuário
        </a></Link>, e outros sites que possuímos e operamos.
      </p>
      ...
      <h2>Política de Cookies Gudbrand Loja de Artigos do Vestuário</h2>
      ...
      <p>
        ...
        os cookies sem desativar completamente a funcionalidade e os recursos que
        eles adicionam a este site. É recomendável que você deixe todos os
      ...
      <ul>
        <li>
          Cookies relacionados à conta<br /><br />
           ...
           Esses cookies geralmente serão excluídos quando você sair do sistema,
        ...
        <li>
          ...
          dessa ação. Isso evita que você precise fazer login sempre que
          ...
          apenas a recursos e áreas restritas ao efetuar login.<br /><br />
        </li>
        <li>
        ...
        <li>
          ...
          páginas, para que possamos processá-lo adequadamente.<br /><br />
        </li>
        <li>
      ...
      <p>
        ...
        que o Gudbrand Loja de Artigos do Vestuário oferece no site e com caráter
      ...
      <ul>
        <li>
          ...
          fé a à ordem pública;</li> <li>B) Não difundir propaganda ou conteúdo
        de natureza racista, xenofóbica, ou sobre cassinos,
        casas de apostas legais, jogos de sorte e azar, qualquer tipo de pornografia
        ilegal, de apologia ao terrorismo ou contra os direitos humanos;
        </li>
        <li>
          C) Não causar danos aos sistemas físicos (hardwares) e lógicos
          (softwares) do Gudbrand Loja de Artigos do Vestuário, de seus
      ...
      <strong>Fevereiro</strong>/<strong>2021</strong>.
      </p>
    </css.Container>
  )
}