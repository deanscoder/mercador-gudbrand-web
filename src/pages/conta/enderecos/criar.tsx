...
export default function CriarEndereco() {
  ...
  async function Salvar(): Promise<void> {
    if (TestaIntegridade()) {
      ...
      perfil_temporario.enderecos.push(endereco)
      ...
      <css.ContainerEnderecos>
        <ul>
          ...
          <li>
            <div>
              <InputMask
                ...
                value={endereco.tel}
                onChange={(e) => setEndereco(prev => ({ ...prev, tel: e.target.value.replace(/\D/g, "") }))} />
            </div>
          </li>
          ...
          <li>
            ...
            <span> Tornar endereço padrão</span>
          </li>
          <li>
            <css.LinkConfirmarEndereco onClick={() => Salvar()}>Confirmar</css.LinkConfirmarEndereco>
          </li>
        </ul>
