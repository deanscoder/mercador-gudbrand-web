...
export default function notas_de_privacidade() {

  return (
    <>
      <Navegacao nome="Notas de Privacidade e Cookies" />
      <css.Container>
        <Head>
          <meta name="robots" content="noindex,nofollow" />
          <meta name="description" content="A sua privacidade é importante para nós. É política do Mercador Gudbrand 
      ...
      informação sua que possamos coletar no site"/>
        ...
        <p>
          A sua privacidade é importante para nós. É política do <b>Mercador Gudbrand</b> respeitar a sua privacidade em relação a qualquer
      informação sua que possamos coletar no site <Link href='https://gudbrand.com.br'><a> <b>Mercador Gudbrand</b>
        ...
        <h2>Política de Cookies <b>Mercador Gudbrand</b></h2>
        ...
        que o <b>Mercador Gudbrand</b> oferece no site e com caráter
        ...
        <ul>
          ...
          (softwares) do <b>Mercador Gudbrand</b>, de seus
